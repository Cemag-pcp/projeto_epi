...
urlpatterns = [
    ...
    path("entregas/devolucoes/itens/", views.DevolucaoFuncionarioItensView.as_view(), name="devolucao_itens"),
    path(
        "entregas/devolucoes/confirmar/",
        views.DevolucaoFuncionarioConfirmView.as_view(),
        name="devolucao_confirmar",
    ),
    path("entregas/<int:pk>/detalhes/", views.EntregaDetailView.as_view(), name="detail"),
    path("entregas/<int:pk>/devolver/", views.EntregaDevolucaoCreateView.as_view(), name="devolver"),
