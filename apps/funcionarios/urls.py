...
urlpatterns = [
    ...
    path("funcionarios/fichas-epi/", views.FichasEPIView.as_view(), name="fichas_epi"),
    path(
        "funcionarios/fichas-epi/relatorio/",
        views.FichasEPIReportView.as_view(),
        name="fichas_epi_relatorio",
    ),
